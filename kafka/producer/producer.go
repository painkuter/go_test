...
func getValue() string {
	...
	var msg string
	msg = `{"event":"delivery_method_set","date":"2021-03-08T14:01:33Z","data":{"delivery_method_id":903}}`
	//msg = `{"event":"warehouse_set","date":"2021-03-08T14:01:33Z","data":{"external_warehouse_id":21016441599000}}`
	if msg == "" {
		printErrorAndExit(1, "Empty message")
	}
	return msg
}

const envFilePath = "./kafka/.env"
...
func main() {
	...
	if getValue() != "" {
		message.Value = sarama.StringEncoder(getValue())
